...
import useLocationMaps from '@/composables/useLocationMaps'
...
const {zoom, center, pin} = useLocationMaps()
...
<template>
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            />
            <h2 class="font-weight-bold text-center my-5">Ubicación de la propiedad</h2>
            <div class="pb-10">
